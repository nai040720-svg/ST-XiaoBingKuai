                  ...
                  geminiList.querySelectorAll(".toggle-btn").forEach((gBtn) => {
                    if (gBtn !== btn && !gBtn.classList.contains("is-on")) {
                      const kw = gBtn.getAttribute("data-kw") || "";
                       if (kw.includes("哈基米越狱") || kw.includes("哈基米底部越狱") || kw.includes("纯爱系统") || kw.includes("哈基米重八股自检") || kw.includes("防止超雄绝望") || kw.includes("防阴谋论") || kw.includes("友好世界") || kw.includes("友好@人间月下") || kw.includes("防空回哈基米") || kw.includes("防止截断哈基米")) return;
