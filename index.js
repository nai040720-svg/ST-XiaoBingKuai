...
// ── 大分类标题：立体突出感，阴影跟随主题 ──
'#' + ROOT_ID + ' summary { font-size: 11.5px; font-weight: bold; color: var(--SmartThemeBodyColor) !important; padding: 8px 14px 8px 12px; background: var(--SmartThemeBlurTintColor); border: none; border-radius: 6px; cursor: pointer; list-style: none; user-select: none; display: flex; justify-content: space-between; align-items: center; text-transform: uppercase; letter-spacing: 0.05em; transition: all 0.2s; box-shadow: 0 2px 4px var(--SmartThemeShadowColor), inset 0 1px 0 rgba(255,255,255,0.08); }',
'#' + ROOT_ID + ' summary:hover { transform: translateY(-1px); box-shadow: 0 3px 6px var(--SmartThemeShadowColor), inset 0 1px 0 rgba(255,255,255,0.1); }',
'#' + ROOT_ID + ' summary:active { transform: translateY(0); box-shadow: 0 1px 2px var(--SmartThemeShadowColor), inset 0 1px 0 rgba(255,255,255,0.05); }',
